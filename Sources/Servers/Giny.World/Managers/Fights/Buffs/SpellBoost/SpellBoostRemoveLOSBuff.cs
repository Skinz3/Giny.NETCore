...
namespace Giny.World.Managers.Fights.Buffs.SpellBoost
{
    public class SpellBoostRemoveLOSBuff : SpellBoostBuff
    {
        ...
        {
            Target.SpellModifiers.ApplySpellModification(SpellId, CharacterSpellModificationTypeEnum.LOS, 1);
            base.Execute();
        }
        public override void Dispell()
        {
            Target.SpellModifiers.ApplySpellModification(SpellId, CharacterSpellModificationTypeEnum.LOS, 0);
            base.Dispell();
        }
    }
}
