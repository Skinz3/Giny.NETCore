...
namespace Giny.Protocol.Messages
{
    public class IdolSelectRequestMessage : NetworkMessage
    {
        ...
        public IdolSelectRequestMessage(short idolId, bool activate, bool party)
        {
            this.idolId = idolId;
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (idolId < 0)
            {
                throw new System.Exception("Forbidden value (" + idolId + ") on element of IdolSelectRequestMessage.idolId.");
            }
